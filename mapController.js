...
class App{
   ...
   async _userAuth(){
    ...
    _renderErrorCard(){
        //change card inner html
        //show card
        //hide card after 2s

        // const path = document.getElementById('path');
        // const path2 = document.getElementById('path2');
        // document.querySelector('.message-text').textContent = 'Email Already Exists';
        // document.querySelector('.sub-text').textContent = 'Please try using another email.';
  ...
  <div class="message-text-container">
    <p class="message-text">Email Already Exist!</p>
    <p class="sub-text">Please register using another email.</p>
  </div>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 15 15"
